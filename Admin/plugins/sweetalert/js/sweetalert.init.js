    document.querySelector(".sweet-wrong")
        .onclick = function() {
        ...
        document.querySelector(".sweet-success-cancel").onclick = function() {
            swal({
                ...
                e ? swal("Deleted !!", "Hey, your imaginary file has been deleted !!", "success") :
        ...
        document.querySelector(".sweet-prompt").onclick = function() {
            swal({
                ...
                return !1 !== e && ("" === e ? (swal.showInputError("You need to write something!"), !1) :
