        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="post" action="_edit_admin.php?id=<?php echo $data['id_admin']; ?>" enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="form-group col col-md-6 ml-auto">
                                                    <label class="col-form-label">Nama Admin</label>
                                                    <input type="text" name="nm_admin" class="form-control input-default" placeholder="Nama Admin" value="<?php echo $data['nama_admin']; ?>">
                                                    ...
                                                    <textarea type="text" name="alamat" class="form-control input-default" placeholder="Alamat" style="height:184px;" value="<?php echo $data['alamat']; ?>"></textarea>
                                                    <label class="col-form-label">No Hp</label>
                                                    <input type="text" name="no_hp" class="form-control input-default" maxlength="13" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" value="<?php echo $data['no_hp']; ?>" placeholder="No Hp">
                                                </div>
                                                <div class="form-group col col-md-6 ml-auto">
                                                    <label class="col-form-label">Email</label>
                                                    <input type="email" name="email" class="form-control input-default" placeholder="Email" value="<?php echo $data['email']; ?>">
                                                    <label class="col-form-label">Username</label>
                                                    <input type="text" name="username" class="form-control input-default" placeholder="Username" value="<?php echo $data['username']; ?>">
                                                    <label class="col-form-label">Password</label>
                                                    <input type="text" name="password" class="form-control input-default" placeholder="Password" value="<?php echo $data['password']; ?>">
                                                    <label class="col-form-label">Foto Profil</label>
                                                    <input type="file" name="foto" class="form-control input-default" value="<?php echo $data['foto_profil']; ?>">
                                                    <label for=""></label>
                                                    <div class="form-check mb-3">
                                                        <label class="form-check-label">
                                                            <input type="checkbox" class="form-check-input" name="ubah_foto" value="">&nbsp; Ceklis jika ingin mengubah foto</label>
                                                        =======
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="card">
                                                                                                    ...
                                                                                                    <form method="post" action="_tambah_admin.php" enctype="multipart/form-data">
                                                                                                        <div class="row">
                                                                                                            <div class="form-group col col-md-6 ml-auto">
                                                                                                                ...
                                                                                                                <label class="col-form-label">No Hp</label>
                                                                                                                <input type="text" name="no_hp" class="form-control input-default" maxlength="13" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" placeholder="No Hp">
                                                                                                            </div>
                                                                                                            <div class="form-group col col-md-6 ml-auto">
                                                                                                                <label class="col-form-label">Email</label>
                        ...
                        <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                        ...
                                        <form method="post" action="_edit_admin.php" enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="form-group col col-md-6 ml-auto">
                                                    ...
                                                    <label class="col-form-label">No Hp</label>
                                                    <input type="text" name="nohp" class="form-control input-default" maxlength="13" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" placeholder="No Hp">
                                                </div>
                                                <div class="form-group col col-md-6 ml-auto">
                                                    <label class="col-form-label">Email</label>
                                                    <input type="email" name="email" class="form-control input-default" placeholder="Email">
                                    ...
                                    >>>>>>> edcf2edcb5ab1e0b228d8f9f55178db54d621c11
                                </div>
                                <label class="col-form-label">Tanggal</label>
                                <input type="date" name="tanggal" readonly class="form-control input-default" value="<?php echo $data['tanggal_daftar']; ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-footer">
                        <input type="reset" class="btn btn-secondary" value="Reset" style="color:white;">
                        <input type="submit" name="simpan" class="btn btn-prinary" value="Simpan">
                    </div>
                    </form>
                </div>
                <<<<<<< HEAD </div> </div> <div class="modal fade" id="tambahmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">TAMBAH DATA</h5>
                    ...
                    while ($data = mysqli_fetch_array($sql)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <span>
                                    <div class="btn-group mr-2 mb-2">
                                        <a href="_edit_admin.php?id=<?php echo $data['id_admin']; ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                                            <button type="button" name="ok" class="btn btn-primary" data-toggle="modal" data-target="#editmodal" data-whatever="@getbootstrap">
                                                <i class="fa fa-pencil color-muted m-r-5"></i>
                                            </button>
                                        </a>
                                        &nbsp;
